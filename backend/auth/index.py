...
def get_user_by_token(conn, token: str):
    with conn.cursor() as cur:
        cur.execute(
            ...
            f"u.sales_count, u.purchases_count, u.balance, u.created_at "
    ...
    if not row:
        return None
    cols = ["id","name","phone","avatar_url","rating","reviews_count","sales_count","purchases_count","balance","created_at"]
    d = dict(zip(cols, row))
