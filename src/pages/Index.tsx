...
const CITIES = [
  ...
  "Стерлитамак", "Грозный", "Якутск", "Кострома", "Комсомольск-на-Амуре",
  "Петрозаводск", "Таганрог", "Нижневартовск", "Йошкар-Ола", "Братск",
  "Новороссийск", "Дзержинск", "Шахты", "Нальчик", "Орск",
  "Сыктывкар", "Нижнекамск", "Ангарск", "Старый Оскол", "Великий Новгород",
  "Благовещенск", "Прокопьевск", "Химки", "Псков", "Балашиха",
  "Энгельс", "Бийск", "Подольск", "Южно-Сахалинск", "Армавир",
  "Северодвинск", "Петропавловск-Камчатский", "Балаково", "Норильск", "Сызрань",
  "Новочеркасск", "Златоуст", "Каменск-Уральский", "Уссурийск", "Электросталь",
  "Альметьевск", "Салават", "Миасс", "Керчь", "Копейск",
  "Пятигорск", "Рыбинск", "Коломна", "Одинцово", "Хасавюрт",
  "Находка", "Королёв", "Берёзовский", "Серпухов", "Новомосковск",
  "Кисловодск", "Нефтеюганск", "Димитровград", "Нефтекамск", "Черкесск",
  "Дербент", "Камышин", "Невинномысск", "Красногорск", "Муром",
  "Батайск", "Новочебоксарск", "Производственный", "Каспийск", "Мытищи",
  "Кызыл", "Октябрьский", "Ачинск", "Северск", "Новый Уренгой",
  "Елец", "Сергиев Посад", "Арзамас", "Обнинск", "Новошахтинск",
  "Элиста", "Майкоп", "Жуковский", "Люберцы", "Ноябрьск",
  "Артём", "Пушкино", "Бердск", "Междуреченск", "Первоуральск",
  "Назрань", "Ленинск-Кузнецкий", "Электросталь", "Альметьевск", "Зеленодольск",
  "Тобольск", "Серов", "Глазов", "Ессентуки", "Воткинск",
  "Кинешма", "Великие Луки", "Новокуйбышевск", "Ухта", "Балашов",
  "Гатчина", "Бузулук", "Озёрск", "Усть-Илимск", "Альметьевск",
  "Воркута", "Соликамск", "Лысьва", "Каменск-Шахтинский", "Чайковский",
  "Усолье-Сибирское", "Магадан", "Долгопрудный", "Реутов", "Ейск",
  "Минеральные Воды", "Жигулёвск", "Туапсе", "Лобня", "Анапа",
  "Геленджик", "Когалым", "Ивантеевка", "Дубна", "Кропоткин",
  "Кстово", "Тихорецк", "Михайловск", "Сарапул", "Канск",
  "Бугульма", "Ливны", "Чапаевск", "Белорецк", "Лесосибирск",
  "Кириши", "Клин", "Россошь", "Кумертау", "Заречный",
  "Выборг", "Будённовск", "Урюпинск", "Краснокамск", "Балахна",
  "Феодосия", "Сибай", "Михайловка", "Усинск", "Югорск",
  "Котлас", "Прохладный", "Вязьма", "Гуково", "Лангепас",
  "Краснокаменск", "Боровичи", "Белово", "Анжеро-Судженск", "Юрга",
  "Киселёвск", "Кунгур", "Тимашёвск", "Михайловск", "Лабинск",
  "Назарово", "Шуя", "Балтийск", "Сосновый Бор", "Ялта",
  "Минусинск", "Зеленогорск", "Радужный", "Лермонтов", "Лиски",
  "Беслан", "Аксай", "Светлоград", "Зерноград", "Калач-на-Дону",
  "Слюдянка", "Тулун", "Шелехов", "Свободный", "Спасск-Дальний",
  "Дальнегорск", "Партизанск", "Биробиджан", "Белогорск", "Бирск",
  "Кропоткин", "Апатиты", "Кандалакша", "Мончегорск", "Печора",
  "Инта", "Алатырь", "Канаш", "Шумерля", "Цивильск",
  "Гай", "Бугуруслан", "Сорочинск", "Абдулино", "Медногорск",
  "Кувандык", "Ясный", "Новотроицк", "Соль-Илецк", "Кировград",
  "Ревда", "Полевской", "Асбест", "Сухой Лог", "Богданович",
  "Камышлов", "Ирбит", "Качканар", "Краснотурьинск", "Карпинск",
  "Реж", "Тавда", "Туринск", "Артёмовский", "Алапаевск",
  "Нижняя Тура", "Кушва", "Красноуфимск", "Верхняя Пышма", "Среднеуральск",
  "Дегтярск", "Заречный", "Волчанск", "Ивдель", "Нягань",
  "Урай", "Мегион", "Пыть-Ях", "Лянтор", "Покачи",
